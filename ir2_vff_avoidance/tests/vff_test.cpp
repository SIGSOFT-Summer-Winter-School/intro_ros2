...
#include "ir2_vff_avoidance/AvoidanceNode.hpp"

#include "gtest/gtest.h"

using namespace std::chrono_literals;

class AvoidanceNodeTest : public ir2_vff_avoidance::AvoidanceNode
{
public:
  ir2_vff_avoidance::VFFVectors
  ...
  get_debug_vff_test(const ir2_vff_avoidance::VFFVectors & vff_vectors)
  {
